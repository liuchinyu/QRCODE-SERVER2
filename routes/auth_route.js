    ...
    if (numbers > 1) {
      if (domain == "gmail.com") {
        mailOptions = {
          ...
          html: `
          <p>${username} 您好，<span style="color:red">您已取票成功！</span></p>
          <p>附件為您所領取的入場電子票券QRCODE，</p>
          <p style="color:red">再請協助將入場電子票券QRCODE轉發給其它出席人員，每張入場電子票券QRCODE僅限1人使用</p>
    ...
    // 數量單張直接以圖片呈現
      ...
      if (domain == "gmail.com") {
        mailOptions = {
          ...
          html: `
            <p>${username} 您好，<span style="color:red">您已取票成功！</span></p>
            <p>下方為您的入場票券QRCODE，<span style="color:red">每張入場電子票券QRCODE僅限1人使用</span></p>
            <p>當天於驗票口出示即可入場，期待您一同前來共襄盛舉!</p>
            <p>入場票券QRCODE</p>
